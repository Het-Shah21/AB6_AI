...
from src.youtube_agent.schemas import YouTubeEvent, AgentState
from src.youtube_agent.agent import YouTubeAgent
...
function createPlayer(videoId) {
  player = new YT.Player('player', {
    ...
    videoId: videoId,
    playerlets: {autoplay:0, rel:0, modestbranding:1},
